...
int main(){
  ...
  n++;
  P=find_cross(Point<int>(0,0), Point<int>(6,8), Point<int>(6,0), Point<int>(0,8));
  if (P == Point<int>(3,4)) np++;
  else std::cerr << "find_cross error (" << n << "): " << P << "\n";

  n++;
  P=find_cross(Point<int>(1,1), Point<int>(5,3), Point<int>(2,4), Point<int>(4,0));
  if (P == Point<int>(3,2)) np++;
  else std::cerr << "find_cross error (" << n << "): " << P << "\n";

  n++;
  try{
    P=find_cross(Point<int>(1,1), Point<int>(4,3), Point<int>(2,4), Point<int>(2,2));
  ...
  n++;
  try{
    P=find_cross(Point<int>(1,1), Point<int>(4,3), Point<int>(2,4), Point<int>(4,4));
    std::cerr << "find_cross error (" << n << ")\n";
  }
  catch(int i){
    np++;
  ...
  n++;
  try{
    P=find_cross(Point<int>(1,1), Point<int>(4,3), Point<int>(7,5), Point<int>(10,7));
    std::cerr << "find_cross error (" << n << ")\n";
  }
  catch(int i){
    np++;
...
/*  n++;
  P=find_cross(Point<int>(1,1), Point<int>(3,3), Point<int>(2,2), Point<int>(4,4));
  std::cerr << "find_cross : " << P << "\n";
  if (P == Point<int>(3,2)) np++;
  else std::cerr << "find_cross (" << n << "): " << P << "\n";

  n++;
  P=find_cross(Point<int>(1,1), Point<int>(3,3), Point<int>(3,3), Point<int>(4,4));
  if (P == Point<int>(3,2)) np++;
  else std::cerr << "find_cross (" << n << "): " << P << "\n";

  n++;
  P=find_cross(Point<int>(1,1), Point<int>(3,3), Point<int>(1,1), Point<int>(4,4));
  if (P == Point<int>(3,2)) np++;
  else std::cerr << "find_cross (" << n << "): " << P << "\n";

  n++;
  P=find_cross(Point<int>(1,1), Point<int>(3,3), Point<int>(1,1), Point<int>(4,5));
  if (P == Point<int>(3,2)) np++;
  else std::cerr << "find_cross (" << n << "): " << P << "\n";*/
  ...
  n++;
  d=find_dist(Point<int>(-1,7), Point<int>(0,0), Point<int>(6,8));
  if (d == 5) np++;
  else std::cerr << "find_dist error (" << n << "): " << d << "\n";

  n++;
  d=find_dist(Point<int>(-3,0), Point<int>(6,8), Point<int>(0,0));
  if (d == 3) np++;
  else std::cerr << "find_dist error (" << n << "): " << d << "\n";

  n++;
  d=find_dist(Point<int>(12,16), Point<int>(6,8), Point<int>(0,0));
  if (d == 10) np++;
  else std::cerr << "find_dist error (" << n << "): " << d << "\n";
