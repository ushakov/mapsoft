...
Параметры --google, --nom и --geom друг с другом несовместимы.

--rscale <rscale>
    "Обратный масштаб" карты, количество единиц заданных координат на метр карты.
    В случае проекции tmerc -- это обычный обратный масштаб, 10000 для карты 1:10000
