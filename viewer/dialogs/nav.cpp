...
DlgNav::DlgNav(): thread(NULL){
  ...
  Gtk::Table * t =   manage(new Gtk::Table(2,5));
          ...
          //  widget    l  r  t  b  x       y
  t->attach(*sw_upd,  0, 2, 0, 1, Gtk::FILL, Gtk::SHRINK, 3, 3);
  t->attach(*sw_goto, 0, 2, 1, 2, Gtk::FILL, Gtk::SHRINK, 3, 3);
//  t->attach(*sw_trk,  0, 2, 2, 3, Gtk::FILL, Gtk::SHRINK, 3, 3);
  ...
  t->attach(*crd,     0, 2, 4, 5, Gtk::FILL, Gtk::SHRINK, 3, 3);
