...
main(int argc, char **argv){
  ...
  for (fig_world::iterator i=W.begin(); i!=W.end(); i++){
   ...
   if (i->text != ""){
     // MMB! маг. - нафиг!
     if ((i->text == "маг.") || (i->text == "маг") || (i->text == "д") ||
        (i->text == "Д") || (i->text == "подв") || (i->text == "подв.") ||
        (i->text == "шк")){
        continue;
     }
   }
...
//         (type == 0x200052) || // поле
    ...
    if (type == 0x100007){
      ...
      fig_object o = *i; o.line_style=2; o.style_val=6; o.depth--; o.pen_color=0xffffff; NW.push_back(o);
   ...
   // MMB! знаки проходимости - нафиг!
   if ((type == 0x100032) || (type == 0x100033) || (type == 0x100034) || (type == 0x100035)){
     continue;
   }

   // MMB! маг. - нафиг!
   if ((i->comment.size()>0) && (i->comment[0] == "маг.") || (i->comment[0] == "маг")){
     continue;
   }
