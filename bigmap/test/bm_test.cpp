...
main(){
  ...
  // jpeg::load("sample/01.jpg") -- картинка в виде Image<int>m
  // 1,1 - положение кусочка в карте
  ...
  M.add(jpeg::load("01.jpg"), 1,1,  0, 0, 227, 63, 30,334, 235,327);
  ...
  M.add(jpeg::load("02.jpg"), 2,1,   8,63,   0, 0, 16,328, 252,320);
  M.add(jpeg::load("03.jpg"), 1,2,  41,22, 246, 15,  0,  0, 254,251);
  ...
  M.add(jpeg::load("04.jpg"), 2,2,  5, 24, 241,17, 13,259,   0,  0);
