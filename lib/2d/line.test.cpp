...
main(){
  ...
  // +,-,*,/
  assert(type_to_str(l1) == "[[0,0],[2,2],[2,0],[0,0]]");
  assert(type_to_str(l1+iPoint(1,2)) == "[[1,2],[3,4],[3,2],[1,2]]");
  assert(type_to_str(l1-iPoint(1,-1)) == "[[-1,1],[1,3],[1,1],[-1,1]]");
  assert(type_to_str(l1*2) == "[[0,0],[4,4],[4,0],[0,0]]");
  assert(type_to_str(l1/2) == "[[0,0],[1,1],[1,0],[0,0]]");

  assert(type_to_str(l1+=iPoint(1,2)) == "[[1,2],[3,4],[3,2],[1,2]]");
  assert(type_to_str(l1-=iPoint(1,1)) == "[[0,1],[2,3],[2,1],[0,1]]");
  assert(type_to_str(l1*=2) == "[[0,2],[4,6],[4,2],[0,2]]");
  assert(type_to_str(l1/=3) == "[[0,0],[1,2],[1,0],[0,0]]");
